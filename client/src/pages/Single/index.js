        ...
        <nav aria-label="Breadcrumb" className="lg:px-0 xl:px-0 px-4">
            <ol role="list" className="mx-auto flex max-w-2xl items-center space-x-2 lg:max-w-7xl lg:px-0 text-xs text-white pb-4">
              {product.breadcrumbs.map((breadcrumb) => (
                <li key={breadcrumb.id}>
                  <div className="flex items-center text-black">
                    <Link to={breadcrumb.href} className="mr-2 text-xs font-medium text-gray-600">
                      {breadcrumb.name}
                    </Link>
                    /
                  </div>
              ...
              <li className="text-xs">
                <a href={product.href} aria-current="page" className="font-medium text-black">
                  {movie.title}
                </a>
              </li>
            </ol>
          </nav>
          {/* <h3 class="text-3xl font-bold text-white">{movie.title}</h3> */}
        </div>
      {/* Product info */}
